      ...
      <div class="row">
        <div class="col-lg-6 col-offset-1">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-footer">
              <a class="btn btn-danger" href="host-view.php">Host View</a>
              <a class="btn btn-danger" href="participant-view.php">Participant View</a>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-offset-1">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-footer">
              <a class="btn btn-success" href="past-archives.php">Past Archives</a>
            </div>
          </div>
